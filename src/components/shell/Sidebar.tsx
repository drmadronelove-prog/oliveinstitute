...
export function Sidebar({
  ...
  studentCourses?: CourseLink[] | null;
}) {
  ...
  return (
    <aside className="w-full shrink-0 md:w-64">
      <details
        open
        className="group shadow-tile rounded-[14px] border border-black/10 bg-gradient-to-b from-[var(--color-cream-warm-top)] to-[var(--color-cream-warm)]"
      >
