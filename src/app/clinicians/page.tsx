...
const TITLE = "Courses for clinicians";
const DESCRIPTION =
  "Self-paced clinical training from Olive Institute: evidence-led courses for practising clinicians, with no cohort schedule to keep up with.";

export const metadata: Metadata = {
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: absoluteUrl("/clinicians") },
  openGraph: {
    type: "website",
    siteName: SITE_NAME,
    title: TITLE,
    description: DESCRIPTION,
    url: absoluteUrl("/clinicians"),
  },
...
export default async function CliniciansPage() {
  const courses = await listPublishedCourses(Track.CLINICIAN);
  ...
  return (
    <PublicShell>
      <div className="mx-auto max-w-7xl px-6 py-12 md:px-10">
        ...
        <CatalogGrid
          courses={courses}
          emptyMessage="No clinician courses are published yet. Check back soon."
        />
      </div>
    </PublicShell>
  );
